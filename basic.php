...
<div class="widget-box">
          ...
          <div class="widget-content"> <a href="#myModal" data-toggle="modal" class="btn btn-success">basic10</a> 
            <a href="#myModal2" data-toggle="modal" class="btn btn-success">basic20</a>
            <a href="#myModal3" data-toggle="modal" class="btn btn-success">basic30</a>
            <a href="#myModal4" data-toggle="modal" class="btn btn-success">basic40</a>
        ...
        key:<input type="text" name="basic10">
            <input type="submit">
        </p>
              </div>
            </div>
