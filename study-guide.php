...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-list"></i>Forms</a>
  ...
  <li  class="active"><a href="study-guide.php"> <span>STUDY-GUIDE</span></a> </li>
</li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> HOME</a> <a href="#">CTF-2015</a> <a href="#" class="current">STUDY-GUIDE</a> </div>
    <h1>STUDY-GUIDE</h1>
</div>
